...
var app = (function () {
    ...
    const convertedImages = writable([]);

    /* src/UploadImg.svelte generated by Svelte v3.45.0 */

    const { console: console_1$1 } = globals;
    const file_1 = "src/UploadImg.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file_1, 28, 1, 696);
    			attr_dev(div, "class", "svelte-1oj4nq0");
    			add_location(div, file_1, 27, 0, 689);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			t0 = space();
    			create_component(uploadimg0.$$.fragment);
    			t1 = space();
    			create_component(uploadimg1.$$.fragment);
    			t2 = space();
    			...
    			add_location(main, file, 48, 0, 1382);
    			add_location(button, file, 54, 1, 1493);
    			if (!src_url_equal(img.src, img_src_value = /*src*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "non");
    			add_location(img, file, 55, 1, 1536);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(uploadimg0, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(uploadimg1, target, anchor);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(uploadimg0.$$.fragment, local);
    			transition_in(uploadimg1.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(uploadimg0.$$.fragment, local);
    			transition_out(uploadimg1.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			if (detaching) detach_dev(t0);
    			destroy_component(uploadimg0, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(uploadimg1, detaching);
    ...
    function instance($$self, $$props, $$invalidate) {
    	let $convertedImages;
    	validate_store(convertedImages, 'convertedImages');
    	component_subscribe($$self, convertedImages, $$value => $$invalidate(2, $convertedImages = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const upload = async () => {
    		...
    		JSON.stringify($convertedImages);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('decodedImg' in $$props) decodedImg = $$props.decodedImg;
    	};
